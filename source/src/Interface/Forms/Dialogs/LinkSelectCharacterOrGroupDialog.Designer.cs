...
namespace Ginger
{
	partial class LinkSelectCharacterOrGroupDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.imageList_Light.Images.SetKeyName(9, "character_group.png");
			this.imageList_Light.Images.SetKeyName(10, "character_neutral_empty.png");
			this.imageList_Light.Images.SetKeyName(11, "character_male_empty.png");
			this.imageList_Light.Images.SetKeyName(12, "character_female_empty.png");
			this.imageList_Light.Images.SetKeyName(13, "character_other_empty.png");
			this.imageList_Light.Images.SetKeyName(14, "character_neutral_empty_lore.png");
			this.imageList_Light.Images.SetKeyName(15, "character_male_empty_lore.png");
			this.imageList_Light.Images.SetKeyName(16, "character_female_empty_lore.png");
			this.imageList_Light.Images.SetKeyName(17, "character_other_empty_lore.png");
			this.imageList_Light.Images.SetKeyName(18, "character_group_empty.png");
			// 
			// toolTip
			// 
			...
			this.imageList_Dark.Images.SetKeyName(9, "character_group.png");
			this.imageList_Dark.Images.SetKeyName(10, "character_neutral_empty.png");
			this.imageList_Dark.Images.SetKeyName(11, "character_male_empty.png");
			this.imageList_Dark.Images.SetKeyName(12, "character_female_empty.png");
			this.imageList_Dark.Images.SetKeyName(13, "character_other_empty.png");
			this.imageList_Dark.Images.SetKeyName(14, "character_neutral_empty_lore.png");
			this.imageList_Dark.Images.SetKeyName(15, "character_male_empty_lore.png");
			...
			this.imageList_Dark.Images.SetKeyName(18, "character_group_empty.png");
			// 
