...
namespace Ginger
{
	public class ContextString
	{
		...
		private string RandomWord(string words, IRandom randomizer)
		{
		...
		private List<string> ScopedSplit(string s, char delimiter)
		{
		...
		private string ConditionalWord(string s, bool condition)
		{
